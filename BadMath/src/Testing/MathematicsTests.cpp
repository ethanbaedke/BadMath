...
static void DEBUG_Matrix44(const Matrix44& matrix)
{
...
static void TEST_Matrix44(const Matrix44& matA, const Matrix44& matB)
{
...
static void DEBUG_SphericalVector(const SphericalVector& vector)
{
...
static void DEBUG_CylindricalVector(const CylindricalVector& vector)
{
...
static void DEBUG_CartesianVector(const CartesianVector& vector)
{
...
static void TEST_CartesianVector(const CartesianVector& vecA, const CartesianVector& vecB)
{
...
static void TEST_CylindricalVector(const CylindricalVector& vecA, const CylindricalVector& vecB)
{
...
static void TEST_SphericalVector(const SphericalVector& vecA, const SphericalVector& vecB)
{
...
static void DEBUG_Quaternion(const Quaternion& quaternion)
{
...
static void TEST_Quaternion(const Quaternion& quat, const CartesianVector& vec)
{
